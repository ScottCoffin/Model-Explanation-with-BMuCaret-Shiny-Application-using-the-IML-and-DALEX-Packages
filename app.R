...
ui <- fluidPage(theme = shinytheme("darkly"),
                ...
                h5("BMuCaret App. built with", img(src = 
                   ...
                   "by",
                   br(), 
                   "Original Code Author: Abderrahim Lyoubi-Idrissi", 
                   br(),
                   "Modified by: Scott Coffin",
                   br(),
                   "Code available at: https://github.com/ScottCoffin/Model-Explanation-with-BMuCaret-Shiny-Application-using-the-IML-and-DALEX-Packages",
                   br())
)
